...
from track import *
from dynamics_models import BicycleDynamicsModelTwoWheelDriveWithBrakeNWH
...
model = BicycleDynamicsModelTwoWheelDriveWithBrakeNWH(params,track,front_tire_model,rear_tire_model)
...
X0 = casadi.DM([tau0,0,phi0,v0,0,0,0,v0/params['front_wheel_radius'],v0/params['rear_wheel_radius']])
...
def optimize(X0,forward_N):  
    ...
    opti.subject_to(opti.bounded(0,front_wheel_omega,v_max/params['front_wheel_radius']))
    opti.subject_to(opti.bounded(0,rear_wheel_omega,v_max/params['rear_wheel_radius']))
    #opti.subject_to(wheel_omega>0)
